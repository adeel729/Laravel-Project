...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title text-center">Reciept Voucher</h5>
    ...
    <div class="panel-body">
        ...
        @endif --}}
        <form class="form-horizontal form-validate-jquery" action="{{url('/store')}}" method="post">
            @csrf
...
<div class="col-md-3">
    ...
    <select  class="form-control" id="d_a_id" name="debit_a_id" >
        @foreach ($data as $act)
...
<div class=" col-md-4">
    ...
    <select  class="form-control" id="a_a_id" name="credit_a_id" required>
...
<div class="col-md-5">
    ...
    <input type="Text" class="form-control" id="contact" placeholder="Description" name="description" style="color:blue" required >
    </div>
 </div>
 ...
 <div class="col-md-3 ml-20">
    <div class="form-group">
    <label>Amount</label>
    <input type="number" class="form-control" id="email" placeholder="" name="amount" required>
    </div>
...
{{-- <div class="form-group col-lg-3 ml-10">
    ...
    <select  class="form-control" id="a_a_id" name="p_id" required>
    <option value="">None</option>
...
<div class="card-footer" >
    <button type="submit" class="btn btn-primary text-right"  style="color:white; margin-top:80px;" name="done" >Save And Continue</button>
    <button class="btn btn-primary text-right" style=" color:white; margin-top:80px;" onclick=" window.open('index.php')">Cancel</button>
    </div>
<!--  -->
...
{{-- SELECT `account_sub_group_id`, `account_sub_group_name` FROM `account_sub_group` WHERE `account_group_id` --}}
<script>
