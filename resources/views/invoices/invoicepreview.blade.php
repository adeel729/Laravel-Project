...
<body>
	<header>
        ...
        <div class="content" style="margin-top:-260px; margin-left:250px;  padding:5px; width:500px;">
            <table>
                <tr>
                    <td colspan="3" align="center"><h2  style="padding:0px;margin :0px;">Invoice</h2></td>
...
<h5 style="margin:5px 2px 2px 510px ; padding: 10px; border:1px solid;font-weight:normal;font-size:12px;">TOTAL:    PKR {{$mastercash->nettotal}}/-</h5>
