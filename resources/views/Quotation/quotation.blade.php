...
<div class="panel panel-flat">
    <div class="panel-heading">
        <h5 class="panel-title text-center">Create Quotation</h5>
    ...
    <div class="panel-body">
        ...
        <form class="form-horizontal form-validate-jquery" action="{{url('/quotation')}}" method="post">
            @csrf
        ...
        <!-- /first name -->
            ...
            <div class="col-md-2 ml-10">
            <div class="form-group">
            <label for="date_of_birth">Quotation Date</label>
            <input type="date" class="form-control" id="quotationdate" required name="quotationdate">
            </div>
            </div>
           <!-- /Quotation Date -->
                    <!--Total Without Tax  -->
...
<div class="row">
    ...
    <div class="col-md-2 ml-10">
        <div class="form-group">
      <label for="nettotal">Price Validity</label>
     <textarea name="pricevalidity" id="" cols="7" rows="2" class="form-control"></textarea>
        </div>
          </div>
          {{-- /price validity --}}
                {{-- Payment terms --}}
    ...
    <div class="col-md-2 ml-10">
        <div class="form-group">
      <label for="nettotal">Payment Term</label>
     <textarea name="paymentterm" id="" cols="7" rows="2" class="form-control"></textarea>
        </div>
          </div>
          {{-- /Payment terms--}}
                      {{-- Deliev --}}
    ...
    <div class="col-md-2 ml-10">
        <div class="form-group">
      <label for="nettotal">Deliver</label>
     <textarea name="deliver" id="" cols="15" rows="5" class="form-control"></textarea>
        </div>
          </div>
          {{-- /Deliev--}}
</div>
...
var total_rows = 0;
        function addItem()
        {
            ...
            html += '<td class="col-md-2 "><select required name="itemid[]" style="margin-left:-20px; width:190px; " id="item_list_'+items+'"     onchange="get_stock_unitprice(this.value,'+items+')"   class=" item_names"  > <option value="">Select item</option></select></td>';
                html += "<td><input required style='width:80px;  margin-left:-8px; height:20px;' id='TotalStock_"+items+"'    readonly  name='totalstock[]' placeholder='Total stock'></td>";
                ...
                html += "<td> <input required type='float' style='width:60px; margin-left:-50px; height:20px;'  id='quantity_"+items+"' onkeyup='total_without_tax(this.value,"+items+")' name='quantity[]' placeholder='quantity'></td>";
